.. Visgraph documentation master file, created by
   sphinx-quickstart on Thu Oct  6 14:52:34 2022.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Visgraph Documentation
======================

The visgraph application is a tool for visualizing graphs through the web
...
Lastly, developers can interface with the visgraph API to engineer graph simulations which users can easily apply to a live visualization session.

The server and web client are written in Javascript using the Express and React frameworks.
